...
<div class="container-fluid bg-light text-dark py-3">
        <header class="text-center">
            <h1 class="display-6"><b>Achievment</b></h1>            
       </header>         
       </div>
        <div class="button">
          <a href="achivementinsert"  aria-pressed="true">Add Achievement</a>  
       </div>
...
<a href="achievementedit?id=${a.id}">Edit</a>  |
<a href="achievementsdelete?id=${a.id}">Delete</a>
</td>
    </tr>
</c:forEach>
  </tbody>
