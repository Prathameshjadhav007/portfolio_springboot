...
<title>Achievement update</title>
    ...
    <form action="addachievements" method="post">
        <div class="form-group row pt-3">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" value="${edit.title}" name="title" id="inputtitle" placeholder="title">
            </div>
          </div>
                    <div class="form-group row">
                <label for="inputmes2" class="col-sm-2 col-form-label">Subtitle</label>
                <div class="col-sm-10">
            <textarea class="form-control" id="inputmes2" name="subtitle" placeholder="Subtitle">${edit.subtitle}</textarea>
          </div>
        </div>
        <div class="form-group row">
          <div class="col-sm-10 button">
            <button type="submit" class="btn btn-primary">save</button>
            <button type="button" class="btn btn-primary"><a class="text-light" href="Achievementdisplay">cancel</a></button>
          </div>
        </div>
      </form>
         </div>
