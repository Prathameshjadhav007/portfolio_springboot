  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <form action="addproject" method="post">
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" name="projectname" id="inputtitle" placeholder="Project Name">
            </div>
          </div>
               <div class="form-group row">
                <label for="inputmes2" class="col-sm-2 col-form-label">Discription</label>
                <div class="col-sm-10">
            <textarea class="form-control" id="inputmes2" name="Description" placeholder="Discription"></textarea>
          </div>
        </div>
     <div class="form-group row">
          <div class="col-sm-10 button text-light">
            <input type="submit" value="save" class="btn btn-primary">
            <button type="button" class="btn btn-primary"><a class="text-light text-decoration-none" href="projectdisplay">cancel</a></button>
